...
export default function DocumentUploadZone({ taskId, onUploadComplete, disabled = false, disabledReason }: DocumentUploadZoneProps) {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        disabled={disabled}
        title={disabled ? disabledReason : 'Upload documents to provide context'}
          ...
          <div>
            ...
            >
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                PDF, TXT, CSV, TSV files up to 10MB each
              </p>
            </div>
